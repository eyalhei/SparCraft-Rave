...
namespace SparCraft
{
    class RaveSearchParameters;
}

class SparCraft::RaveSearchParameters
{											        // DEFAULT				DESCRIPTION
    ...
    double          _cValue;                        // 1                    C constant for Rave formula
    size_t          _maxTraversals;                 // 100                  Max number of Rave traversals to make
